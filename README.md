...
│
├── notebooks/
│   ├── 01_Definicion_del_problema.ipynb
│   ├── 02_Recoleccion_de_Datos.ipynb
│   ├── 03_Preprocesamiento_de_Datos.ipynb
│   ├── 04_Analisis_Exploratorio_de_Datos.ipynb
│   ├── 05_Entrenamiento_CNN.ipynb
│   ├── 06_Evaluacion_del_Modelo.ipynb
│   ├── 07_Fine_tuning_Gemma_3_con_QLoRA.ipynb
│   ├── 08_RAG_con_FAISS.ipynb
│   ├── 09_Pipeline_Completo.ipynb
│   ├── 09_B_Evaluacion_LLM_Rubricas_Clinicas.ipynb
